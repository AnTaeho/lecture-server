package com.example.lectureserver.queue;
...
public class QueueServiceTest {
    ...
    void beforeEach() {
        ...
        User user = new User("username", "email@email.com", "password123456789");
    ...
    void issueTokenAndEnqueueWaitingQueueTest() {
        ...
        for (int i = 1000; i < 2000; i++) {
            User savedUser = userRepository.save(new User("username", "email@email.com", "passwordpassowrd"));
    ...
    void updateQueueTest() {
        ...
        // 마지막에 접근한 1명을 기록
        Long lastUserId = userRepository.save(new User("username", "email@email.com", "passwordpassowrd")).getId();
